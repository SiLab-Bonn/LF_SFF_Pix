...
def AC_sweep(load_data=False,DC=False):
    ...
    plt.legend()
    plt.savefig(image_path+'IBN_data'+image_format,bbox_inches='tight')
    plt.close()
    ...
    plt.legend()
    plt.savefig(image_path+'IBP_data'+image_format,bbox_inches='tight')
    plt.close()
    ...
    if chip_version != 'DC':
        ...
        plt.ylabel('$C_{in}$ / fF')
        plt.grid()
        plt.savefig(image_path+chip_version+'_C_in'+image_format,bbox_inches='tight')
        plt.close()
        ...
        plt.ylabel('$R_{off} / M\Omega$')
        plt.grid()
        plt.savefig(image_path+chip_version+'_R_off'+image_format,bbox_inches='tight')
        plt.close()
    ...
    plt.ylabel('Gain $G$')
    plt.grid()
    plt.savefig(image_path+chip_version+'_AC_Gain'+image_format,bbox_inches='tight')
    plt.close()
